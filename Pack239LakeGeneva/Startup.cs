  ...
  public class Startup
  {
    ...
    public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
    {
      ...
      app.Use(async (context, next) =>
      {
        ...
        context.Response.Headers.Add("Content-Security-Policy", "connect-src 'self' https://dc.services.visualstudio.com; default-src 'self' https://*.google.com; font-src https://fonts.googleapis.com/ https://fonts.gstatic.com/; img-src 'self' data: https://*.google.com https://*.googleapis.com https://*.googleusercontent.com https://www.google-analytics.com https://stats.g.doubleclick.net; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://www.googletagmanager.com https://www.google-analytics.com https://*.google.com https://*.msecnd.net; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com https://www.google.com");
