...
namespace Pack239LakeGeneva
{
  public class Startup
  {
    ...
    public void Configure(IApplicationBuilder app, IHostingEnvironment env)
    {
      ...
      {
        context.Response.Headers.Add("Content-Security-Policy", "connect-src 'self' https://dc.services.visualstudio.com; default-src 'self'; font-src https://fonts.gstatic.com/; img-src 'self' data: https://drive.google.com https://drive-thirdparty.googleusercontent.com https://www.google-analytics.com https://stats.g.doubleclick.net; script-src 'self' https://www.googletagmanager.com https://www.google-analytics.com https://*.msecnd.net; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com");
